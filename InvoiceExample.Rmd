---
title: "ES VAT Invoice - `r params$invoice`"
output: pdf_document
...
invoiceData <- transactionData %>%
  filter(INVOICE_NUMBER == params$invoice)
...
invoiceData %>%
  ...
  kbl(booktabs = TRUE, caption.short = TRUE, position = 'h') %>%
...
invoiceData %>%
  ...
  kbl(booktabs = TRUE,  caption.short = TRUE, position = 'h', centering = FALSE) 
```
